...
class $ClientSyncInfosTable extends ClientSyncInfos
  ...
  List<GeneratedColumn> get $columns =>
      [device_info, token, created_at, id, updated_at];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'client_sync_infos';
  @override
...
class ClientSyncInfo extends DataClass implements Insertable<ClientSyncInfo> {
  ...
  @override
  int get hashCode =>
      Object.hash(device_info, token, created_at, id, updated_at);
  @override
...
class $SyncsTable extends Syncs with TableInfo<$SyncsTable, Sync> {
  ...
  @override
  late final GeneratedColumn<int> row_id = GeneratedColumn<int>(
...
class SyncsCompanion extends UpdateCompanion<Sync> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    if (row_id.present) {
      map['row_id'] = Variable<int>(row_id.value);
    }
...
class $FragmentMemoryInfosTable extends FragmentMemoryInfos
  ...
  @override
  late final GeneratedColumn<bool> be_synced = GeneratedColumn<bool>(
      'be_synced', aliasedName, false,
      type: DriftSqlType.bool,
      requiredDuringInsert: true,
      defaultConstraints:
          GeneratedColumn.constraintIsAlways('CHECK ("be_synced" IN (0, 1))'));
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'fragment_memory_infos';
  @override
...
class $MemoryGroupSmartCycleInfosTable extends MemoryGroupSmartCycleInfos
  ...
  late final GeneratedColumn<int> creator_user_id = GeneratedColumn<int>(
      'creator_user_id', aliasedName, false,
      type: DriftSqlType.int, requiredDuringInsert: true);
  static const VerificationMeta _loop_cycleMeta =
      const VerificationMeta('loop_cycle');
  @override
  ...
  late final GeneratedColumn<int> memory_group_id = GeneratedColumn<int>(
      'memory_group_id', aliasedName, false,
      type: DriftSqlType.int, requiredDuringInsert: true);
  static const VerificationMeta _small_cycle_incremental_new_learn_countMeta =
      const VerificationMeta('small_cycle_incremental_new_learn_count');
  @override
  late final GeneratedColumn<int> small_cycle_incremental_new_learn_count =
      GeneratedColumn<int>(
          'small_cycle_incremental_new_learn_count', aliasedName, false,
          type: DriftSqlType.int, requiredDuringInsert: true);
  static const VerificationMeta _small_cycle_incremental_review_countMeta =
      const VerificationMeta('small_cycle_incremental_review_count');
  @override
  late final GeneratedColumn<int> small_cycle_incremental_review_count =
      GeneratedColumn<int>(
          'small_cycle_incremental_review_count', aliasedName, false,
          type: DriftSqlType.int, requiredDuringInsert: true);
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('loop_cycle')) {
      context.handle(
          _loop_cycleMeta,
          loop_cycle.isAcceptableOrUnknown(
    ...
    if (data.containsKey('small_cycle_incremental_new_learn_count')) {
      context.handle(
          _small_cycle_incremental_new_learn_countMeta,
          small_cycle_incremental_new_learn_count.isAcceptableOrUnknown(
              data['small_cycle_incremental_new_learn_count']!,
              _small_cycle_incremental_new_learn_countMeta));
    } else if (isInserting) {
      context.missing(_small_cycle_incremental_new_learn_countMeta);
    }
    if (data.containsKey('small_cycle_incremental_review_count')) {
      context.handle(
          _small_cycle_incremental_review_countMeta,
          small_cycle_incremental_review_count.isAcceptableOrUnknown(
              data['small_cycle_incremental_review_count']!,
              _small_cycle_incremental_review_countMeta));
    } else if (isInserting) {
      context.missing(_small_cycle_incremental_review_countMeta);
    }
  ...
  MemoryGroupSmartCycleInfo map(Map<String, dynamic> data,
    ...
    return MemoryGroupSmartCycleInfo(
      ...
      memory_group_id: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}memory_group_id'])!,
      small_cycle_incremental_new_learn_count: attachedDatabase.typeMapping.read(
          DriftSqlType.int,
          data['${effectivePrefix}small_cycle_incremental_new_learn_count'])!,
      small_cycle_incremental_review_count: attachedDatabase.typeMapping.read(
          DriftSqlType.int,
          data['${effectivePrefix}small_cycle_incremental_review_count'])!,
...
class MemoryGroupSmartCycleInfo extends DataClass
  ...
  int memory_group_id;
  int small_cycle_incremental_new_learn_count;
  int small_cycle_incremental_review_count;
  ...
  MemoryGroupSmartCycleInfo(
      ...
      required this.memory_group_id,
      required this.small_cycle_incremental_new_learn_count,
      required this.small_cycle_incremental_review_count,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['memory_group_id'] = Variable<int>(memory_group_id);
    map['small_cycle_incremental_new_learn_count'] =
        Variable<int>(small_cycle_incremental_new_learn_count);
    map['small_cycle_incremental_review_count'] =
        Variable<int>(small_cycle_incremental_review_count);
  ...
  MemoryGroupSmartCycleInfosCompanion toCompanion(bool nullToAbsent) {
    return MemoryGroupSmartCycleInfosCompanion(
      ...
      memory_group_id: Value(memory_group_id),
      small_cycle_incremental_new_learn_count:
          Value(small_cycle_incremental_new_learn_count),
      small_cycle_incremental_review_count:
          Value(small_cycle_incremental_review_count),
  ...
  factory MemoryGroupSmartCycleInfo.fromJson(Map<String, dynamic> json,
    ...
    return MemoryGroupSmartCycleInfo(
      ...
      memory_group_id: serializer.fromJson<int>(json['memory_group_id']),
      small_cycle_incremental_new_learn_count: serializer
          .fromJson<int>(json['small_cycle_incremental_new_learn_count']),
      small_cycle_incremental_review_count: serializer
          .fromJson<int>(json['small_cycle_incremental_review_count']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'memory_group_id': serializer.toJson<int>(memory_group_id),
      'small_cycle_incremental_new_learn_count':
          serializer.toJson<int>(small_cycle_incremental_new_learn_count),
      'small_cycle_incremental_review_count':
          serializer.toJson<int>(small_cycle_incremental_review_count),
  ...
  MemoryGroupSmartCycleInfo copyWith(
      ...
      MemoryGroupSmartCycleInfo(
        ...
        small_cycle_incremental_new_learn_count:
            small_cycle_incremental_new_learn_count ??
                this.small_cycle_incremental_new_learn_count,
        small_cycle_incremental_review_count:
            small_cycle_incremental_review_count ??
                this.small_cycle_incremental_review_count,
  ...
  String toString() {
    return (StringBuffer('MemoryGroupSmartCycleInfo(')
          ...
          ..write('memory_group_id: $memory_group_id, ')
          ..write(
              'small_cycle_incremental_new_learn_count: $small_cycle_incremental_new_learn_count, ')
          ..write(
              'small_cycle_incremental_review_count: $small_cycle_incremental_review_count, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is MemoryGroupSmartCycleInfo &&
          ...
          other.memory_group_id == this.memory_group_id &&
          other.small_cycle_incremental_new_learn_count ==
              this.small_cycle_incremental_new_learn_count &&
          other.small_cycle_incremental_review_count ==
              this.small_cycle_incremental_review_count &&
...
class MemoryGroupSmartCycleInfosCompanion
  ...
  Value<int> memory_group_id;
  Value<int> small_cycle_incremental_new_learn_count;
  Value<int> small_cycle_incremental_review_count;
  ...
  MemoryGroupSmartCycleInfosCompanion({
    ...
    this.memory_group_id = const Value.absent(),
    this.small_cycle_incremental_new_learn_count = const Value.absent(),
    this.small_cycle_incremental_review_count = const Value.absent(),
  ...
  static Insertable<MemoryGroupSmartCycleInfo> custom({
    ...
    Expression<int>? memory_group_id,
    Expression<int>? small_cycle_incremental_new_learn_count,
    Expression<int>? small_cycle_incremental_review_count,
    ...
    return RawValuesInsertable({
      ...
      if (memory_group_id != null) 'memory_group_id': memory_group_id,
      if (small_cycle_incremental_new_learn_count != null)
        'small_cycle_incremental_new_learn_count':
            small_cycle_incremental_new_learn_count,
      if (small_cycle_incremental_review_count != null)
        'small_cycle_incremental_review_count':
            small_cycle_incremental_review_count,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (small_cycle_incremental_new_learn_count.present) {
      map['small_cycle_incremental_new_learn_count'] =
          Variable<int>(small_cycle_incremental_new_learn_count.value);
    }
    if (small_cycle_incremental_review_count.present) {
      map['small_cycle_incremental_review_count'] =
          Variable<int>(small_cycle_incremental_review_count.value);
    }
...
class $FragmentGroupTagsTable extends FragmentGroupTags
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'fragment_group_tags';
  @override
...
class $RFragment2FragmentGroupsTable extends RFragment2FragmentGroups
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'r_fragment2_fragment_groups';
  @override
  VerificationContext validateIntegrity(
...
class $Test2sTable extends Test2s with TableInfo<$Test2sTable, Test2> {
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'test2s';
  @override
...
class $FragmentsTable extends Fragments
  ...
  @override
  late final GeneratedColumn<bool> be_sep_publish = GeneratedColumn<bool>(
      'be_sep_publish', aliasedName, false,
      type: DriftSqlType.bool,
      requiredDuringInsert: true,
      defaultConstraints: GeneratedColumn.constraintIsAlways(
          'CHECK ("be_sep_publish" IN (0, 1))'));
  ...
  @override
  late final GeneratedColumn<int> father_fragment_id = GeneratedColumn<int>(
  ...
  Fragment map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Fragment(
      ...
      creator_user_id: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}creator_user_id'])!,
      father_fragment_id: attachedDatabase.typeMapping
...
class Fragment extends DataClass implements Insertable<Fragment> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || father_fragment_id != null) {
      map['father_fragment_id'] = Variable<int>(father_fragment_id);
    }
  ...
  factory Fragment.fromJson(Map<String, dynamic> json,
    ...
    return Fragment(
      ...
      creator_user_id: serializer.fromJson<int>(json['creator_user_id']),
      father_fragment_id: serializer.fromJson<int?>(json['father_fragment_id']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'creator_user_id': serializer.toJson<int>(creator_user_id),
      'father_fragment_id': serializer.toJson<int?>(father_fragment_id),
  ...
  Fragment copyWith(
          ...
          String? content,
          int? creator_user_id,
          Value<int?> father_fragment_id = const Value.absent(),
          String? title,
          DateTime? created_at,
          int? id,
          DateTime? updated_at}) =>
  ...
  @override
  int get hashCode => Object.hash(be_sep_publish, content, creator_user_id,
      father_fragment_id, title, created_at, id, updated_at);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Fragment &&
...
class FragmentsCompanion extends UpdateCompanion<Fragment> {
  ...
  static Insertable<Fragment> custom({
    ...
    Expression<int>? creator_user_id,
    Expression<int>? father_fragment_id,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (father_fragment_id.present) {
      map['father_fragment_id'] = Variable<int>(father_fragment_id.value);
    }
    if (title.present) {
...
class $MemoryAlgorithmsTable extends MemoryAlgorithms
  ...
  late final GeneratedColumn<int> creator_user_id = GeneratedColumn<int>(
      'creator_user_id', aliasedName, false,
      type: DriftSqlType.int, requiredDuringInsert: true);
  static const VerificationMeta _explain_contentMeta =
      const VerificationMeta('explain_content');
  @override
  late final GeneratedColumn<String> explain_content = GeneratedColumn<String>(
      'explain_content', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  ...
  static const VerificationMeta
      _suggest_count_for_new_and_review_algorithmMeta =
      const VerificationMeta('suggest_count_for_new_and_review_algorithm');
  @override
  late final GeneratedColumn<String>
      suggest_count_for_new_and_review_algorithm = GeneratedColumn<String>(
          'suggest_count_for_new_and_review_algorithm', aliasedName, true,
          type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta
  ...
  late final GeneratedColumn<String> suggest_loop_cycle_algorithm =
      GeneratedColumn<String>('suggest_loop_cycle_algorithm', aliasedName, true,
          type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _suggest_loop_cycle_algorithm_remarkMeta =
      const VerificationMeta('suggest_loop_cycle_algorithm_remark');
  @override
  late final GeneratedColumn<String> suggest_loop_cycle_algorithm_remark =
      GeneratedColumn<String>(
          'suggest_loop_cycle_algorithm_remark', aliasedName, true,
          type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _titleMeta = const VerificationMeta('title');
  @override
  late final GeneratedColumn<String> title = GeneratedColumn<String>(
  ...
  List<GeneratedColumn> get $columns => [
        ...
        suggest_loop_cycle_algorithm_remark,
        title,
        created_at,
        id,
        updated_at
  ...
  VerificationContext validateIntegrity(Insertable<MemoryAlgorithm> instance,
    ...
    if (data.containsKey('explain_content')) {
      context.handle(
          _explain_contentMeta,
          explain_content.isAcceptableOrUnknown(
              data['explain_content']!, _explain_contentMeta));
    }
    ...
    if (data.containsKey('suggest_count_for_new_and_review_algorithm')) {
      context.handle(
          _suggest_count_for_new_and_review_algorithmMeta,
          suggest_count_for_new_and_review_algorithm.isAcceptableOrUnknown(
              data['suggest_count_for_new_and_review_algorithm']!,
              _suggest_count_for_new_and_review_algorithmMeta));
    }
    if (data.containsKey('suggest_count_for_new_and_review_algorithm_remark')) {
      context.handle(
          _suggest_count_for_new_and_review_algorithm_remarkMeta,
          suggest_count_for_new_and_review_algorithm_remark
    ...
    if (data.containsKey('suggest_loop_cycle_algorithm_remark')) {
      context.handle(
          _suggest_loop_cycle_algorithm_remarkMeta,
          suggest_loop_cycle_algorithm_remark.isAcceptableOrUnknown(
              data['suggest_loop_cycle_algorithm_remark']!,
              _suggest_loop_cycle_algorithm_remarkMeta));
    }
    if (data.containsKey('title')) {
      context.handle(
  ...
  MemoryAlgorithm map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return MemoryAlgorithm(
      ...
      creator_user_id: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}creator_user_id'])!,
      explain_content: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}explain_content']),
      ...
      suggest_count_for_new_and_review_algorithm: attachedDatabase.typeMapping
          .read(
              DriftSqlType.string,
              data[
                  '${effectivePrefix}suggest_count_for_new_and_review_algorithm']),
      suggest_count_for_new_and_review_algorithm_remark:
          attachedDatabase.typeMapping.read(
              DriftSqlType.string,
              data[
      ...
      suggest_loop_cycle_algorithm_remark: attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}suggest_loop_cycle_algorithm_remark']),
      title: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}title'])!,
      created_at: attachedDatabase.typeMapping
          .read(DriftSqlType.dateTime, data['${effectivePrefix}created_at'])!,
...
class MemoryAlgorithm extends DataClass implements Insertable<MemoryAlgorithm> {
  ...
  String? suggest_loop_cycle_algorithm_remark;
  String title;
  DateTime created_at;
  int id;
  DateTime updated_at;
  MemoryAlgorithm(
      ...
      this.suggest_loop_cycle_algorithm_remark,
      required this.title,
      required this.created_at,
      required this.id,
      required this.updated_at});
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['creator_user_id'] = Variable<int>(creator_user_id);
    if (!nullToAbsent || explain_content != null) {
      map['explain_content'] = Variable<String>(explain_content);
    }
    ...
    if (!nullToAbsent || suggest_count_for_new_and_review_algorithm != null) {
      map['suggest_count_for_new_and_review_algorithm'] =
          Variable<String>(suggest_count_for_new_and_review_algorithm);
    }
    if (!nullToAbsent ||
    ...
    if (!nullToAbsent || suggest_loop_cycle_algorithm_remark != null) {
      map['suggest_loop_cycle_algorithm_remark'] =
          Variable<String>(suggest_loop_cycle_algorithm_remark);
    }
    map['title'] = Variable<String>(title);
    map['created_at'] = Variable<DateTime>(created_at);
    map['id'] = Variable<int>(id);
  ...
  MemoryAlgorithmsCompanion toCompanion(bool nullToAbsent) {
    return MemoryAlgorithmsCompanion(
      ...
      creator_user_id: Value(creator_user_id),
      explain_content: explain_content == null && nullToAbsent
          ? const Value.absent()
          : Value(explain_content),
      ...
      suggest_count_for_new_and_review_algorithm:
          suggest_count_for_new_and_review_algorithm == null && nullToAbsent
              ? const Value.absent()
              : Value(suggest_count_for_new_and_review_algorithm),
      suggest_count_for_new_and_review_algorithm_remark:
          suggest_count_for_new_and_review_algorithm_remark == null &&
                  nullToAbsent
              ? const Value.absent()
      ...
      suggest_loop_cycle_algorithm_remark:
          suggest_loop_cycle_algorithm_remark == null && nullToAbsent
              ? const Value.absent()
              : Value(suggest_loop_cycle_algorithm_remark),
      title: Value(title),
      created_at: Value(created_at),
      id: Value(id),
      updated_at: Value(updated_at),
  ...
  factory MemoryAlgorithm.fromJson(Map<String, dynamic> json,
    ...
    return MemoryAlgorithm(
      ...
      creator_user_id: serializer.fromJson<int>(json['creator_user_id']),
      explain_content: serializer.fromJson<String?>(json['explain_content']),
      familiarity_algorithm:
      ...
      suggest_count_for_new_and_review_algorithm: serializer.fromJson<String?>(
          json['suggest_count_for_new_and_review_algorithm']),
      suggest_count_for_new_and_review_algorithm_remark:
      ...
      suggest_loop_cycle_algorithm_remark: serializer
          .fromJson<String?>(json['suggest_loop_cycle_algorithm_remark']),
      title: serializer.fromJson<String>(json['title']),
      created_at: serializer.fromJson<DateTime>(json['created_at']),
      id: serializer.fromJson<int>(json['id']),
      updated_at: serializer.fromJson<DateTime>(json['updated_at']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'creator_user_id': serializer.toJson<int>(creator_user_id),
      'explain_content': serializer.toJson<String?>(explain_content),
      'familiarity_algorithm':
      ...
      'suggest_count_for_new_and_review_algorithm': serializer
      ...
      'suggest_loop_cycle_algorithm_remark':
          serializer.toJson<String?>(suggest_loop_cycle_algorithm_remark),
      'title': serializer.toJson<String>(title),
      'created_at': serializer.toJson<DateTime>(created_at),
      'id': serializer.toJson<int>(id),
      'updated_at': serializer.toJson<DateTime>(updated_at),
  ...
  MemoryAlgorithm copyWith(
          ...
          int? creator_user_id,
          Value<String?> explain_content = const Value.absent(),
          ...
          Value<String?> suggest_loop_cycle_algorithm_remark =
              const Value.absent(),
          String? title,
          DateTime? created_at,
          int? id,
      ...
      MemoryAlgorithm(
        ...
        completed_algorithm_remark: completed_algorithm_remark.present
            ...
            : this.completed_algorithm_remark,
        creator_user_id: creator_user_id ?? this.creator_user_id,
        explain_content: explain_content.present
            ? explain_content.value
            : this.explain_content,
        ...
        next_time_algorithm_remark: next_time_algorithm_remark.present
            ...
            : this.next_time_algorithm_remark,
        suggest_count_for_new_and_review_algorithm:
            suggest_count_for_new_and_review_algorithm.present
                ? suggest_count_for_new_and_review_algorithm.value
                : this.suggest_count_for_new_and_review_algorithm,
        suggest_count_for_new_and_review_algorithm_remark:
        ...
        suggest_loop_cycle_algorithm: suggest_loop_cycle_algorithm.present
            ...
            : this.suggest_loop_cycle_algorithm,
        suggest_loop_cycle_algorithm_remark:
            suggest_loop_cycle_algorithm_remark.present
                ? suggest_loop_cycle_algorithm_remark.value
                : this.suggest_loop_cycle_algorithm_remark,
        title: title ?? this.title,
        created_at: created_at ?? this.created_at,
        id: id ?? this.id,
  ...
  String toString() {
    return (StringBuffer('MemoryAlgorithm(')
          ...
          ..write('creator_user_id: $creator_user_id, ')
          ..write('explain_content: $explain_content, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is MemoryAlgorithm &&
          ...
          other.creator_user_id == this.creator_user_id &&
          other.explain_content == this.explain_content &&
          ...
          other.suggest_count_for_new_and_review_algorithm ==
              this.suggest_count_for_new_and_review_algorithm &&
          other.suggest_count_for_new_and_review_algorithm_remark ==
              this.suggest_count_for_new_and_review_algorithm_remark &&
          other.suggest_loop_cycle_algorithm ==
              this.suggest_loop_cycle_algorithm &&
          other.suggest_loop_cycle_algorithm_remark ==
              this.suggest_loop_cycle_algorithm_remark &&
          other.title == this.title &&
          other.created_at == this.created_at &&
          other.id == this.id &&
...
class MemoryAlgorithmsCompanion extends UpdateCompanion<MemoryAlgorithm> {
  ...
  MemoryAlgorithmsCompanion({
    ...
    this.creator_user_id = const Value.absent(),
    this.explain_content = const Value.absent(),
    ...
    this.suggest_loop_cycle_algorithm_remark = const Value.absent(),
    this.title = const Value.absent(),
    this.created_at = const Value.absent(),
    this.id = const Value.absent(),
    this.updated_at = const Value.absent(),
  ...
  static Insertable<MemoryAlgorithm> custom({
    ...
    Expression<int>? creator_user_id,
    Expression<String>? explain_content,
    ...
    Expression<String>? suggest_loop_cycle_algorithm_remark,
    Expression<String>? title,
    Expression<DateTime>? created_at,
    Expression<int>? id,
    Expression<DateTime>? updated_at,
    ...
    return RawValuesInsertable({
      ...
      if (creator_user_id != null) 'creator_user_id': creator_user_id,
      if (explain_content != null) 'explain_content': explain_content,
      ...
      if (suggest_count_for_new_and_review_algorithm != null)
        'suggest_count_for_new_and_review_algorithm':
            suggest_count_for_new_and_review_algorithm,
      ...
      if (suggest_loop_cycle_algorithm != null)
        'suggest_loop_cycle_algorithm': suggest_loop_cycle_algorithm,
      if (suggest_loop_cycle_algorithm_remark != null)
        'suggest_loop_cycle_algorithm_remark':
            suggest_loop_cycle_algorithm_remark,
      if (title != null) 'title': title,
      if (created_at != null) 'created_at': created_at,
  ...
  MemoryAlgorithmsCompanion copyWith(
    ...
    return MemoryAlgorithmsCompanion(
      ...
      creator_user_id: creator_user_id ?? this.creator_user_id,
      explain_content: explain_content ?? this.explain_content,
      familiarity_algorithm:
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (explain_content.present) {
      map['explain_content'] = Variable<String>(explain_content.value);
    }
    ...
    if (suggest_count_for_new_and_review_algorithm.present) {
      map['suggest_count_for_new_and_review_algorithm'] =
          Variable<String>(suggest_count_for_new_and_review_algorithm.value);
    }
    if (suggest_count_for_new_and_review_algorithm_remark.present) {
      map['suggest_count_for_new_and_review_algorithm_remark'] =
          Variable<String>(
              suggest_count_for_new_and_review_algorithm_remark.value);
    }
    ...
    if (suggest_loop_cycle_algorithm_remark.present) {
      map['suggest_loop_cycle_algorithm_remark'] =
          Variable<String>(suggest_loop_cycle_algorithm_remark.value);
    }
    if (title.present) {
      map['title'] = Variable<String>(title.value);
    }
...
class $MemoryGroupsTable extends MemoryGroups
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'memory_groups';
  @override
...
class $ShorthandsTable extends Shorthands
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'shorthands';
  @override
...
class $FragmentGroupBeSavedsTable extends FragmentGroupBeSaveds
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'fragment_group_be_saveds';
  @override
  VerificationContext validateIntegrity(
...
class $FragmentGroupLikesTable extends FragmentGroupLikes
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'fragment_group_likes';
  @override
...
class $FragmentGroupsTable extends FragmentGroups
  ...
  @override
  late final GeneratedColumn<bool> be_publish = GeneratedColumn<bool>(
      'be_publish', aliasedName, false,
      type: DriftSqlType.bool,
      requiredDuringInsert: true,
      defaultConstraints:
          GeneratedColumn.constraintIsAlways('CHECK ("be_publish" IN (0, 1))'));
  ...
  @override
  late final GeneratedColumn<int> father_fragment_groups_id =
      GeneratedColumn<int>('father_fragment_groups_id', aliasedName, true,
          type: DriftSqlType.int, requiredDuringInsert: false);
  static const VerificationMeta _jump_to_fragment_groups_idMeta =
      const VerificationMeta('jump_to_fragment_groups_id');
  @override
  late final GeneratedColumn<int> jump_to_fragment_groups_id =
      GeneratedColumn<int>('jump_to_fragment_groups_id', aliasedName, true,
          type: DriftSqlType.int, requiredDuringInsert: false);
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'fragment_groups';
  @override
...
class FragmentGroup extends DataClass implements Insertable<FragmentGroup> {
  ...
  int? jump_to_fragment_groups_id;
  String profile;
  String title;
  DateTime created_at;
  int id;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || father_fragment_groups_id != null) {
      map['father_fragment_groups_id'] =
          Variable<int>(father_fragment_groups_id);
    }
    if (!nullToAbsent || jump_to_fragment_groups_id != null) {
      map['jump_to_fragment_groups_id'] =
          Variable<int>(jump_to_fragment_groups_id);
    }
  ...
  factory FragmentGroup.fromJson(Map<String, dynamic> json,
    ...
    return FragmentGroup(
      ...
      creator_user_id: serializer.fromJson<int>(json['creator_user_id']),
      father_fragment_groups_id:
          serializer.fromJson<int?>(json['father_fragment_groups_id']),
      jump_to_fragment_groups_id:
          serializer.fromJson<int?>(json['jump_to_fragment_groups_id']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'creator_user_id': serializer.toJson<int>(creator_user_id),
      'father_fragment_groups_id':
          serializer.toJson<int?>(father_fragment_groups_id),
      'jump_to_fragment_groups_id':
          serializer.toJson<int?>(jump_to_fragment_groups_id),
  ...
  FragmentGroup copyWith(
          ...
          Value<int?> jump_to_fragment_groups_id = const Value.absent(),
          String? profile,
          String? title,
          DateTime? created_at,
          int? id,
...
class FragmentGroupsCompanion extends UpdateCompanion<FragmentGroup> {
  ...
  Value<int?> jump_to_fragment_groups_id;
  ...
  static Insertable<FragmentGroup> custom({
    ...
    Expression<int>? jump_to_fragment_groups_id,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (father_fragment_groups_id.present) {
      map['father_fragment_groups_id'] =
          Variable<int>(father_fragment_groups_id.value);
    }
    if (jump_to_fragment_groups_id.present) {
      map['jump_to_fragment_groups_id'] =
          Variable<int>(jump_to_fragment_groups_id.value);
    }
    if (profile.present) {
...
class $UserFollowsTable extends UserFollows
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'user_follows';
  @override
