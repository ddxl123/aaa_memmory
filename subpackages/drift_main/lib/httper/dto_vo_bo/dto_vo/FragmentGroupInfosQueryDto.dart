...
/// 
@JsonSerializable()
class FragmentGroupInfosQueryDto extends BaseObject{
...
FragmentGroupInfosQueryDto({
  ...
  factory FragmentGroupInfosQueryDto.fromJson(Map<String, dynamic> json) => _$FragmentGroupInfosQueryDtoFromJson(json);
    
  @override
  Map<String, dynamic> toJson() => _$FragmentGroupInfosQueryDtoToJson(this);
  ...
  Future<T> handleCode<T>({
    ...
    // message: 获取成功！
    // explain: 获取当前碎片组的 FragmentGroupInfo。
    required Future<T> Function(String showMessage, FragmentGroupInfosQueryVo vo) code151701,
    
    }) async {
    try {

        if (code == 151701) return await code151701(successMessage!, vo!);
